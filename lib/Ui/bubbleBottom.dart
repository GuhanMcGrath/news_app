    ...
    return BubbleBottomBar(
        ...
        items: <BubbleBottomBarItem>[
          ...
          BubbleBottomBarItem(
              ...
              activeIcon: Icon(Icons.search_sharp, color: Colors.grey,),
              title: Text("Search")
          ),
          BubbleBottomBarItem(
              backgroundColor: Colors.black,
              icon: Icon(Icons.category,color: Colors.black,),
              activeIcon: Icon(Icons.category,color: Colors.grey,),
              title: Text('Categories')),
          BubbleBottomBarItem(backgroundColor: Colors.black,
              icon: Icon(Icons.bookmark_border, color: Colors.black,),
              activeIcon: Icon(Icons.bookmark_border, color: Colors.grey,),
              title: Text("BookMark")
          )
        ]
    );
